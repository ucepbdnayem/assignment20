...
export default function Footer() {
    return (
        <section className='w-full sticky top-[100vh]'> 
            <footer className="footer px-10 py-4 border-t border-white bg-base-200 text-base-content">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Blog Magazine. <br/>Providing reliable tech since 2023</p>
                </aside> 
